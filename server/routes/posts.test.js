...
describe('GET /api/v1/posts/2', () => {
  it('returns a post', () => {
    postDb.getPostById.mockImplementation(
      postId => Promise.resolve(mockPosts.find(post => post.id === postId))
    )
...
describe('POST /api/v1/posts', () => {
  it('adds and returns a post', () => {
    ...
    postDb.addPost.mockImplementation(
      (newPost, authorId) => Promise.resolve({ id: 3, authorId, ...newPost })
    )
